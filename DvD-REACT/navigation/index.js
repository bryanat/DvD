...
// FUTURE: next step is to get colorScheme working with AuthProvider wrapper /
// default export // 1 current problem: if auth is default export, then auth
// context doesnt work / is undefined // 2 current problem: if colorscheme is
// not default export, then colorscheme doesnt work // 3 current problem: have
// to put colorscheme in NavigationContainer (only NavigationContainer has theme
// prop) // below is a way that solves 123 if can get Navigation to
// conditionally render via a ternary operator
                    ...
                    headerRight: () => (<View
                        ...
                        <Pressable
                            ...
                            <Ionicons
                                ...
                                name="notifications-outline" size={25} color={Colors[colorScheme].text} style={{
                                    marginRight: 15
                                }}/>
                        </Pressable>
                        <Pressable
